...
import Model.NgayCong;
import Model.NgayCongDAO;
 ...
 * @author Other
 */
public class QuanlyNgayCongDialog extends javax.swing.JDialog {

    NhanvienDAO nvDAO = new NhanvienDAO();
    NgayCongDAO NgaycongDAO = new NgayCongDAO();
    int index = 0;

    /**
     * Creates new form QuanlydiemDialog
     */
    public QuanlyNgayCongDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void fillDataTABLE() {
        DefaultTableModel model = (DefaultTableModel) tblNgayCongNhanVien.getModel();
        model.setRowCount(0);
        for (NgayCong d : NgaycongDAO.getAllNgayCong()) {
            Object rowData[] = new Object[7];
            rowData[0] = d.getnv().getMaNV();
            rowData[1] = d.getnv().getTenNV();
            rowData[2] = d.getsongaycong();
            rowData[3] = d.getsongaynghi();
            rowData[4] = d.getgiolamthem();
//            rowData[5] = d.getTBC();
//            rowData[6] = d.getXeploai();
    ...
    private void initComponents() {
        ...
        tblNgayCongNhanVien = new javax.swing.JTable();
        ...
        txtsongaycong.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtsongaycongActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtsongaycong, javax.swing.GroupLayout.PREFERRED_SIZE, 218, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtsongaynghi, javax.swing.GroupLayout.PREFERRED_SIZE, 218, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtgiolamthem, javax.swing.GroupLayout.PREFERRED_SIZE, 218, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addContainerGap()
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(txtsongaycong, javax.swing.GroupLayout.DEFAULT_SIZE, 32, Short.MAX_VALUE))
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtsongaynghi, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel7))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(txtgiolamthem, javax.swing.GroupLayout.DEFAULT_SIZE, 29, Short.MAX_VALUE)
        ...
        tblNgayCongNhanVien.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tblNgayCongNhanVien.setSelectionBackground(new java.awt.Color(153, 204, 255));
        tblNgayCongNhanVien.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblNgayCongNhanVienMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tblNgayCongNhanVien);
    ...
    public void setModel(NgayCong d) {
        txtsongaycong.setText(String.valueOf(d.getsongaycong()));
        txtsongaynghi.setText(String.valueOf(d.getsongaynghi()));
        txtgiolamthem.setText(String.valueOf(d.getgiolamthem()));
        txtManv.setText(d.getnv().getMaNV());
        txtHoTen.setText(d.getnv().getTenNV());
//        txtDiemTB.setText(String.valueOf(d.getTBC()));
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        if (validateForm()) {
            if (NgaycongDAO.delNgaycong(txtManv.getText()) > 0) {
                fillDataTABLE();
            }
        } else {
    ...
    private void btnCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCapNhatActionPerformed
        ...
        if (validateForm()) {
            NgayCong d = getModel();
            if (NgaycongDAO.updateNgaycong(d) > 0) {
    ...
    public boolean validateForm() {
        if (txtManv.getText().isEmpty()
                ...
                || txtsongaycong.getText().isEmpty()
                || txtsongaynghi.getText().isEmpty()
                || txtgiolamthem.getText().isEmpty()) {
            return false;
//        } else {
//            try {
...
//        return true;
    ...
    public NgayCong getModel() {
        NgayCong d = new NgayCong();
        d.setId(0);
        Nhanvien nv = new Nhanvien(txtManv.getText(), txtHoTen.getText());
        d.setnv(nv);
        d.setsongaycong(Double.parseDouble(txtsongaycong.getText()));
        d.setgiolamthem(Double.parseDouble(txtgiolamthem.getText()));
        d.setsongaynghi(Double.parseDouble(txtsongaynghi.getText()));
        return d;
    }
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        ...
        NgayCong d = NgaycongDAO.getAllPosition(index);
        setModel(d);
    ...
    private void btnNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextActionPerformed
        // TODO add your handling code here:
        index++;
        if (index <= NgaycongDAO.getAllNgayCong().size() - 1) {
            index = NgaycongDAO.getAllNgayCong().size() - 1;
        }
        NgayCong d = NgaycongDAO.getAllPosition(index);
        setModel(d);
...
//        txtDiemTB.setText("");
    ...
    private void tblNgayCongNhanVienMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblNgayCongNhanVienMouseClicked
        // bắt sự kiện click vào bảng
        int id = tblNgayCongNhanVien.rowAtPoint(evt.getPoint());
        String masv = tblNgayCongNhanVien.getValueAt(id, 0).toString();
        NgayCong d = NgaycongDAO.getOneNgayCongByMaNV(masv);
        setModel(d);
    }//GEN-LAST:event_tblNgayCongNhanVienMouseClicked
    ...
    private void btnTimKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimKiemActionPerformed
        ...
        if (txtMaSVTK.getText().isEmpty()) {
            ...
            Boolean sinhvien = nvDAO.hasNhanVienByID(txtMaSVTK.getText());
            if (sinhvien != null) {
                JOptionPane.showMessageDialog(this, "Mã NV tồn tại");
            }
            Nhanvien sv = nvDAO.getNhanVienByID(txtMaSVTK.getText());
            if (sv != null) {
                NgayCong d = NgaycongDAO.getOneNgayCongByMaNV(sv.getMaNV());
                if (d != null) {
                    setModel(d);
                } else {
                    // Set thông tin và điểm lên form, nếu chưa có điểm thì để mặc định là 0
                    txtManv.setText(sv.getMaNV());
                    txtHoTen.setText(sv.getTenNV());
                    txtsongaycong.setText("0");
                    txtsongaynghi.setText("0");
                    txtgiolamthem.setText("0");
//                    txtDiemTB.setText("0.0");
    ...
    private void txtsongaycongActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtsongaycongActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtsongaycongActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuanlyNgayCongDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                QuanlyNgayCongDialog dialog = new QuanlyNgayCongDialog(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTable tblNgayCongNhanVien;
